...
export const couponApi = {
  getList: (params) => request.get('/v1/admin/coupons', { params }),
  getCoupons: (params) => request.get('/v1/admin/coupons', { params }),
  add: (data) => request.post('/v1/admin/coupons', data),
  addCoupon: (data) => request.post('/v1/admin/coupons', data),
  update: (id, data) => request.put(`/v1/admin/coupons/${id}`, data),
  updateCoupon: (id, data) => request.put(`/v1/admin/coupons/${id}`, data),
  delete: (id) => request.delete(`/v1/admin/coupons/${id}`),
  deleteCoupon: (id) => request.delete(`/v1/admin/coupons/${id}`),
  getDetail: (id) => request.get(`/v1/admin/coupons/${id}`),
  getStats: (id) => request.get(`/v1/admin/coupons/${id}/stats`),
  getOverviewStats: () => request.get('/v1/admin/coupons/stats/overview')
}
